  ...
  return (
    <div className="Home">
      <div className="home-head">
        ...
        <p>
          {" "}
          8 to 10½ years Develop new skills. Soar to great heights. Being a Cub
        ...
        <div className="first-container">
          <div className="image-container-1">
            <div className="container-1-text">
              <p>
                Being a Cub When you join Cubs, you’ll be introduced to lots of
                new activities, people and things.
              </p>
            </div>
          </div>
        </div>
