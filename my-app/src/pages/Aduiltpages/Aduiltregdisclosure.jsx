        ...
        <div className="A-profile-align">
          ...
          <div className="A-profile-card">
            <div className="reg-disc-text">
              ...
              <p>
                Click on the button below and you will be taken to mygoc.scot
                once here you can apply for a disclosure check to be carried
                out, once this is complete forward to results to your local
